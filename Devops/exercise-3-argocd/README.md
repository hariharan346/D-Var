...
Apply the ArgoCD Application manifest. Since it is configured to pull the manifests directly from your public GitHub repository (`https://github.com/hariharan346/D-Var.git`), ArgoCD will fetch the configurations directly from the repository sub-folder:
```bash
